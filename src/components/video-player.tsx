  ...
  return (
    ...
    >
      <div className="relative h-0 w-full pb-[56.25%]">
        ...
        <div
          className={cn(
            `absolute bottom-0 left-0 right-0 bg-secondary/10 bg-gradient-to-t from-black/50 to-transparent p-2 transition-transform duration-500 ease-in-out ${
  ...
  return (
    <div className="flex items-center gap-1 bg-gray-300 *:text-sm rounded-md p-1">
      {videoIds.map((video, idx) => (
        ...
        >
          Video {lang[currentLang].multiVideo} {idx + 1}
        </button>
      ))}
    </div>
  );
